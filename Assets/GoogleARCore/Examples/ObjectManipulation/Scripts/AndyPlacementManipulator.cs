...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class AndyPlacementManipulator : Manipulator
    {
        ...
        protected override void OnEndManipulation(TapGesture gesture)
        {
            ...
            //RulerEndsÇ™2å¬à»è„Ç»ÇÁÅAÇªÇÍà»è„ï\é¶ÇµÇ»Ç¢ÇÊÇ§Ç…Ç∑ÇÈ
            GameObject[] RulerEnds;
            int RulerEndsNum;
            RulerEnds = GameObject.FindGameObjectsWithTag("RulerEnd");
            RulerEndsNum = RulerEnds.Length;
            if (RulerEndsNum == 2)
            {
                return;
            }
